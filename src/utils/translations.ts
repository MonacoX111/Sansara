...
admin: {
  ...
  playerClaimCode: "Player claim code",
  currentCode: "Current code",
  linkedUid: "Linked UID",
  linkedAccount: "Linked account",
  claimCodeActive: "Claim code active",
  noClaimCode: "No claim code",
  none: "None",
  ...
  mediaCenterNav: "Media Center",
  mediaCenterTitle: "Media Center / Social Studio",
  mediaStudioEyebrow: "Social Studio",
  mediaCenterSubtitle:
  ...
  mediaTemplateMatchAnnouncementDescription: "Story card with VS layout",
  mediaTemplateMatchResult: "Match Result",
  mediaTemplateMatchResultDescription: "Score, map and MVP layout",
  mediaTemplateGroupStandings: "Group Standings",
  mediaTemplateGroupStandingsDescription: "Table view for group stage",
  mediaTemplatePlayoffBracket: "Playoff Bracket",
  mediaTemplatePlayoffBracketDescription: "Semi-finals and final poster",
  mediaTemplateMvpCard: "MVP Card",
  mediaTemplateMvpCardDescription: "Featured player highlight",
  mediaTemplateChampionPoster: "Champion Poster",
  mediaTemplateChampionPosterDescription: "Winner, MVP and prize layout",
  mediaTournamentPlaceholder: "Select tournament",
  mediaMatchPlaceholder: "Select match",
  mediaSideOne: "Team / Player 1",
  mediaSideTwo: "Team / Player 2",
  mediaStageGroup: "Stage / group",
  mediaStagePlaceholder: "Stage or group",
  mediaDatePlaceholder: "Date / time",
  mediaGroup: "Group",
  mediaGroupPlaceholder: "Group A",
  mediaMap: "Map",
  mediaTournamentTitle: "Tournament title",
  mediaFinalPlaceholder: "Final placeholder",
  mediaFinalPlaceholderText: "Final TBD",
  mediaHighlight: "Highlight text",
  mediaHighlightPlaceholder: "Clutch plays, clean aim, match-defining impact.",
  mediaChampion: "Champion team / player",
  mediaChampionPlaceholder: "Champion",
  mediaFinalScore: "Final score",
  mediaTeamPlayer: "Team / Player",
  mediaParticipantPlaceholder: "Participant",
  mediaPlayerPlaceholder: "Player name",
  mediaSemiFinalOne: "Semi-finalist 1",
  mediaSemiFinalTwo: "Semi-finalist 2",
  mediaSemiFinalThree: "Semi-finalist 3",
  mediaSemiFinalFour: "Semi-finalist 4",
...
teamsPage: {
  ...
  playerBasedWins: "Player-based wins",
  noPlayerBasedWins: "No player-based wins yet",
  wonBy: "Won by",
...
nav: {
 ...
 admin: {
  ...
  playerClaimCode: "Код прив’язки гравця",
  currentCode: "Поточний код",
  linkedUid: "Прив’язаний UID",
  linkedAccount: "Акаунт прив’язано",
  claimCodeActive: "Код активний",
  noClaimCode: "Немає коду",
  none: "Немає",
  generateCode: "Згенерувати код",
  copyCode: "Скопіювати код",
  resetCode: "Скинути код",
  unlinkAccount: "Відв’язати акаунт",
...
teamsPage: {
  ...
  playerBasedWins: "Перемоги через гравців",
  noPlayerBasedWins: "Перемог через гравців поки немає",
  wonBy: "Виграли",
  currentPlayer: "Поточний гравець",
  formerPlayer: "Колишній гравець",
